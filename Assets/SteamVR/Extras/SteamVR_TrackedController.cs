...
public class SteamVR_TrackedController : MonoBehaviour
{
    ...
    public virtual void OnTriggerPulled(float triggerPercent) { }
	...
	protected virtual void Update()
	{
		...
		if (system != null && system.GetControllerState(controllerIndex, ref controllerState, (uint)System.Runtime.InteropServices.Marshal.SizeOf(typeof(VRControllerState_t))))
		{
            ...
            float triggerPercent = SteamVR_Controller.Input((int)controllerIndex).GetAxis(Valve.VR.EVRButtonId.k_EButton_SteamVR_Trigger)[0];
            if (triggerPercent > 0)
            {
                OnTriggerPulled(triggerPercent);
            }
        }
    }
}
